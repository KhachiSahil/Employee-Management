            ...
            <aside id="default-sidebar" className={`fixed top-16 left-0 z-50 w-64 h-screen  transition-transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} sm:translate-x-0`} aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800 dark:bg-gray-800">
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link to="/dashboard" className="flex items-center p-2 bg-white bg-transparent  text-gray-900 rounded-lg text-white hover:bg-gray-700  group">
                        ...
                        <li>
                            <Link to="/dashboard/employees" className="flex items-center p-2 bg-white bg-transparent  text-gray-900 rounded-lg text-white hover:bg-gray-700  group" >
                        ...
                        <li>
                            <Link to="/dashboard/crud" className="flex items-center p-2 bg-white bg-transparent  text-gray-900 rounded-lg text-white hover:bg-gray-700  group">
