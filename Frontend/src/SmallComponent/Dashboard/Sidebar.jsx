            ...
            <aside id="default-sidebar" className={`fixed top-16 left-0 z-50 w-64 h-screen  transition-transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} sm:translate-x-0`} aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800 dark:bg-gray-800">
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link to="/dashboard" className="flex items-center p-2 bg-gray-500 bg-transparent  text-gray-900 rounded-lg text-white hover:bg-gray-700  group">
                        ...
                        <li>
                            <Link to="/dashboard/employees" className="flex items-center p-2 bg-gray-500 bg-transparent  text-gray-900 rounded-lg text-white hover:bg-gray-700  group" >
                            <svg className="w-5 h-5 transition duration-75 text-gray-400 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <li>
                            <Link to="/dashboard/crud" className="flex items-center p-2 bg-gray-500 bg-transparent  text-gray-900 rounded-lg text-white hover:bg-gray-700  group">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 transition duration-75 text-gray-400 group-hover:text-white" fill="currentColor">
