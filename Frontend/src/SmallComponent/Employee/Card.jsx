...
function Card({ name, entries, success }) {
  ...
  return (
    <div className={`bg-gray-800 ${!isChatOpen ? 'hover:scale-105' : ''} transition-all duration-300 ease-in-out shadow-md rounded-md p-4 md:px-8 lg:px-16 xl:px-16 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 md:space-x-8 xl:space-x-16 my-9`}>
      ...
      {isChatOpen && <ChatModal isOpen={isChatOpen} onClose={toggleChatModal} sender = "Admin" recipient={name} />}
