...
function Card({name,entries,success}) {
  return (
    <div className="bg-white dark:bg-gray-800 shadow-md rounded-md p-4 md:px-8 lg:px-16 xl:px-16 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 md:space-x-8 xl:space-x-16 my-9">
      ...
      <div className="text-gray-700 font-black dark:text-gray-300">{name}</div>
      <div className="text-gray-700 dark:text-gray-300">Entries: {entries}</div>
      <div className="text-gray-700 dark:text-gray-300">Success: {success}</div>
